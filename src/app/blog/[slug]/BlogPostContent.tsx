            ...
            <div className="min-w-0 flex-1 w-full max-w-4xl xl:mx-auto">
              ...
              >
                ...
                >
                  <Link
                    href="/blog"
                    className="inline-flex items-center gap-2 text-primary-300 hover:text-primary-400 transition-colors duration-200"
                  >
                    <motion.span
